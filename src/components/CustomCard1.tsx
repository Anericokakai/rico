...
function CustomCard1() {
  return (
    <AppLayout>
      <div className="p-2 mx-auto flex flex-col md:flex-row border rounded-xl max-w-[1008px] border-[#727DA1]/20 bg-[#171824] ">
        <div className="rounded px-8 py-5 flex flex-col max-w-[488px]">
          <div className="mb-10 grow flex flex-col justify-center">
            ...
            <p className="mt-5 text-grayText-1a">
              ...
              Distinctio voluptate dolores temporibus, odio dicta quia natus
              similique ex accusamus deleniti.
            </p>
            <a
              className="-m-1 p-1 group inline-flex items-center text-[#7C87F7]"
              href="/pricing"
            >
              <span className="mr-1">See pricing</span>
            </a>
          </div>
        </div>
        <div className="pt-6 md:py-6 sm:min-w-[383px]">
