...
function toggleDevMood() {
  let mood = devMood[Math.floor(Math.random() * devMood.length)];
  ...
  return (
    <AppLayout>
      <div className="  w-full">
        <h1 className="font-gradient font-effect-hero text-4xl mb-10 sm:text-5xl">
          Example Of Code Block Renderer
        </h1>
